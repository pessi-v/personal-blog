<h2>Deploying Streamlit on EC2, with nginx for port 80 access</h2>
<h4>November 20, 2024</h4>

<p>
	Today I'm writing a description of how I deployed Streamlit version 1.40.1 on Amazon AWS EC2, made
	my process run in the background using systemd and nohup, and set up nginx to forward requests to
	port 80 to my Streamlit app.
</p>

<p>This is in preparation to setting up a subdomain for my app, on which I'll do a writeup soon.</p>
...
<p>
	You should generate an ssh key, or use an existing key you might have created on AWS before. With
	this key, you can later ssh to your instance.
</p>
