<div class="post">
	...
	<p>
		In the last post we looked at a solution for parsing the text content of a webpage, such as a
		news article, using the mozilla/readability.js node package on Rails backend.
	</p>

	<p>
		This time I’ll introduce the <a
			rel="external"
			href="https://github.com/cantino/ruby-readability">‘readability’ gem</a
	...
	<p>
		In my experience however, the parsing doesn’t always manage to identify the previous sections
		from the content.
	</p>
</div>
